...
const PushNotifications = () => {
  ...
  return (
    <SafeAreaView style={{ padding: 8 }}>
      ...
      <PushNotificationsItems title="Offers/Deals" />
      <PushNotificationsItems title="Messages" />
      <PushNotificationsItems title="Voucher/Coupon" />
      <PushNotificationsItems title="Other" />
